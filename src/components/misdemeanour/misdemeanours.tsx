...
export const Misdemeanours: React.FC = () => {
    ...
    const [localMisdemeanours, setLocalMisdemeanours] = useState<
        Array<IMisdemeanour>
    >([]);
    ...
    useEffect(() => {
        ...
        else setLocalMisdemeanours(misdemeanours);
    }, [misdemeanours, filtervalue]);

    return (
        <div className="misdemean__container">
            <div className="misdemean__item item--title misdemean__item--citizenId">
                Citizen ID
            </div>
            <div className="misdemean__item item--title">Date</div>
            <MisdemeanourFilter
                columnName="Misdemeanour"
